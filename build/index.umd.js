(function (global, factory) {
  ...
  */
  ...
  var createInitialState = function createInitialState(currentMonth, locale, containMinAndMaxDates) {
    var endDate = containMinAndMaxDates ? new Date() : getEndDate(currentMonth, locale);
    var startDate = containMinAndMaxDates ? dateFns.startOfWeek(currentMonth, {
      locale: locale
    }) : dateFns.startOfWeek(dateFns.startOfMonth(currentMonth), {
      locale: locale
    });
    return {
      startDate: startDate,
  ...
  function useGrid(_ref) {
    var locale = _ref.locale,
      ...
      containMinAndMaxDates = _ref.containMinAndMaxDates;
    var timeoutRef = React.useRef();
    var containerElementRef = React.useRef();
    var initialDragPositionRef = React.useRef(0);
    var _useReducer = React.useReducer(reducer, createInitialState(currentMonth, locale, containMinAndMaxDates)),
  ...
  function CalendarGrid(_ref) {
    ...
    if (containMinAndMaxDates) {
      monthStartValue = dateFns.startOfWeek(month);
    } else {
      monthStartValue = dateFns.startOfMonth(month);
    }
    var grid = useGrid({
      locale: locale,
  ...
  CalendarGrid.propTypes = {
    ...
    containMinAndMaxDates: propTypes.bool
  };
  ...
  function Calendar(_ref) {
    ...
    return /*#__PURE__*/React__default.createElement("div", null, !hideNavigation && /*#__PURE__*/React__default.createElement(CalendarNavigation, {
      locale: locale,
      minimumDate: minimumDate,
      maximumDate: maximumDate,
      month: month,
  ...
  function DatePickerCalendar(_ref) {
    ...
    if (containMinAndMaxDates) {
      initialStartDate = dateFns.startOfWeek(minimumDate);
    } else {
      initialStartDate = dateFns.startOfMonth(selectedDate || new Date());
    }
    ...
    var _useControllableState = useControllableState(receivedMonth, onMonthChange, initialStartDate),
      _useControllableState2 = _slicedToArray(_useControllableState, 2),
      month = _useControllableState2[0],
      setMonth = _useControllableState2[1];
