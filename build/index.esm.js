...
import { getDate, isToday, format, isSameMonth, getYear, startOfMonth, subMonths, addMonths, differenceInCalendarMonths, endOfWeek, addWeeks, endOfMonth, differenceInCalendarWeeks, startOfWeek, isAfter, isBefore, eachDayOfInterval, lightFormat, startOfDay, differenceInDays, set, isSameDay, isValid, parse } from 'date-fns';
...
var createInitialState = function createInitialState(currentMonth, locale, containMinAndMaxDates) {
  ...
  var startDate = containMinAndMaxDates ? startOfWeek(currentMonth, {
    locale: locale
...
function useGrid(_ref) {
  ...
  var _useReducer = useReducer(reducer, createInitialState(currentMonth, locale, containMinAndMaxDates)),
...
function Calendar(_ref) {
  ...
  return /*#__PURE__*/React.createElement("div", null, !hideNavigation && /*#__PURE__*/React.createElement(CalendarNavigation, {
    locale: locale,
    minimumDate: minimumDate,
    maximumDate: maximumDate,
    month: month,
